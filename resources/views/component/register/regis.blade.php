            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="relative">
                        ...
                        <i class="bi bi-eye-slash size-6 absolute top-10 right-3 cursor-pointer" id="togglePassword"></i>
                    </div>
                    ...
                    <button type="submit" class="focus:outline-none text-gray-900 bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900 hover:text-white">
                        Sign Up
                    </button>
